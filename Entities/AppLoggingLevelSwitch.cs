...
namespace Heizung.ServerDotNet.Entities
{
    ...
    public class AppLoggingLevelSwitch
    {
        ...
        /// <summary>
        /// Dieser LoggingLevelSwitch ist für alle Lognachrichten aktiv, welche als Quelle Microsoft haben. (Überschreibt <see cref="LoggingLevelSwitch"/> für Microsoft-Nachrichten.)
        /// </summary>
        /// <value></value>
        ...
        /// <summary>
        /// Dieser LoggingLevelSwitch ist für alle Lognachrichten aktiv, welche als Quelle 'Client' haben. Das beinhaltet alle Lognarichten vom Web-Client. (Überschreibt <see cref="LoggingLevelSwitch"/> für Client-Nachrichten.)
        /// </summary>
        /// <value></value>
